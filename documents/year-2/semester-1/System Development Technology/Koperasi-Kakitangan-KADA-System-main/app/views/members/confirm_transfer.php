...
<head>
    ...
    <title>Pengesahan Pindahan - KADA</title>
    ...
    <style>
        ...
        /* Update alert and button styles for consistency */
        .alert {
            width: 100%;
            margin: 1.5rem auto;
            padding: 1.25rem;
    ...
    <div class="page-wrapper">
        ...
        <div class="main-wrapper">
            <div class="content-container">
                <!-- Your existing transaction card content -->
                <div class="transaction-card">
                    <div class="transaction-header">
                        <h4 class="mb-0">Pengesahan Pindahan</h4>
                    </div>
                    <div class="transaction-body">
                        <!-- Keep your existing transaction details content -->
                        <div class="transaction-details">
                            ...
                            <div class="transaction-detail">
                                <span class="detail-label">Jumlah Pindahan</span>
                            ...
                            <div class="transaction-detail">
                                <span class="detail-label">No. Akaun Bank</span>
                                <span class="detail-value"><?= htmlspecialchars($bank_account) ?></span>
                            </div>

                            <?php if (isset($transfer_purpose) && !empty($transfer_purpose)): ?>
                            <div class="transaction-detail">
                                <span class="detail-label">Tujuan Pindahan</span>
                                <span class="detail-value"><?= htmlspecialchars($transfer_purpose) ?></span>
                            </div>
                            <?php endif; ?>
                        ...
                        <div class="d-grid gap-3 mt-4">
                            <form action="/members/confirm-transfer" method="POST">
                                <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?>">
                                <button type="submit" class="btn btn-primary w-100 mb-2">
                                    <i class="fas fa-check-circle me-2"></i>Sahkan Pindahan
                                </button>
                            </form>
